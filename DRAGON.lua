...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/M0HIMA/sabo/main/File_Bot/commands.lua") 
...
local UserName = (data.username_ or "UU_DHA_2")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝑫𝑬𝑺𝑨")  
...
send(msg.chat_id_, msg.id_,' ★ اصدار سورس ديشا \n ★ الاصدار »{ v 1.5}')
end
if text == 'ديشا مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/UU_DHA_2"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/UU_A_H_M_E_D25BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗧𝘄𝗮𝘀𝗼𝗹', url="t.me/UU_A_H_M_E_D25BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ★ العضو » ['..result.title_..'](t.me/'..(username or 'UU_DHA_2')..')'
status  = '\n ★ تم ترقيته مطور'
...
usertext = '\n ★ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_DHA_2')..')'
status  = '\n ★ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UU_DHA_2')..') \n ★ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ★ العضو : {["..data.first_name_.."](T.ME/UU_DHA_2)}\n ★ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ★ عذرا » {["..data.first_name_.."](T.ME/UU_DHA_2)}\n ★ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ★ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'UU_DHA_2')..') \n ★ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'UU_DHA_2')..') \n ★ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_," ★ عذرا الملف لايدعم سورس ديشا \n") 
end
return false
end
...
if text and text:match("^رفع ديشا @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ديشا @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ديشا (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ديشا (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ديشا @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ديشا @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ديشا (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ديشا (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ★ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_DHA_2')..')'
status  = '\n ★ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ★ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_DHA_2')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ★ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'UU_DHA_2')..')'..'\n ★ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."UU_DHA_2:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."UU_DHA_2:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."UU_DHA_2:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."UU_DHA_2:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"★تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."UU_DHA_2:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."UU_DHA_2:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ديشا يعني لو بكتهن راح اعرفك انت الاخذتهن
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_DHA_2')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━𝑫𝑬𝑺𝑨━━━━━━≫ٴ\n★ [ 𝑫𝑬𝑺𝑨 ](t.me/UU_DHA_2)')
end
...
{
{text = '⓺', callback_data="/help6"},{text = 'َ⓻', callback_data="/help7"},{text = '⓼', callback_data="/help8"},
},
{
{text = '⓽', callback_data="/help9"},{text = '⑩', callback_data="/help10"},
},
...
keyboard.inline_keyboard = {
{
{text = 'َ⓵', callback_data="/help1"},{text = '⓶', callback_data="/help2"},{text = '⓷', callback_data="/help3"},
},
{
{text = '⓸', callback_data="/help4"},{text = '⓹', callback_data="/help5"},
},
...
{
{text = 'َ⓺', callback_data="/help6"},{text = '⓻', callback_data="/help7"},{text = '⓼', callback_data="/help8"},
},
{
{text = 'َ⓽', callback_data="/help9"},{text = '⑩', callback_data="/help10"},
},
{
{text = ' الاوامر الرئيسيه ', callback_data="/help"},
},
...
{
{text = 'َ⓸', callback_data="/help4"},{text = 'َ⓹', callback_data="/help5"},
},
{
{text = '⓺', callback_data="/help6"},{text = '⓻', callback_data="/help7"},{text = '⓼', callback_data="/help8"},
},
...
{
{text = 'َ⓸', callback_data="/help4"},{text = '⓹', callback_data="/help5"},
},
{
{text = '⓺', callback_data="/help6"},{text = '⓻', callback_data="/help7"},{text = '⓼', callback_data="/help8"},
},
